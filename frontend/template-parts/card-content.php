...
?>
<div class="car-offer">
  <a href="<?php echo get_permalink(8) . $slug; ?>" class="car-picture__block-img">
    <img class="car-picture" src="<?php echo $value->images[0] ?>" alt="car">
  ...
  <div class="you-looked-car__block-describe">
    ...
    <div class="last-visit catalog-last-visit"><?php date('d.m.y',$time)?> </div>
