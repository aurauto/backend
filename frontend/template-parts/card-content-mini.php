...
<a href="<?php echo get_permalink(8) . $slug; ?>" class="you-looked-car">
  <div сlass="you-looked-car__picture-block">
    <img src="<?php echo  $value->images[0]  ?>" onerror="this.src = '<?php echo get_template_directory_uri()?>/assets/images/logo.svg'">

    <p class="name_car"><?php echo $value->brand ?> <?php echo $value->model ?>, <?php echo $value->production_date ?></p>
